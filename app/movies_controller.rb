...
def can_be_found_updated_and_saved
  ...
  u = Movie.find_by({ :title => "Awesome Flick"})
  u.title = "Even Awesomer Flick"
  u.save
end
...
def can_update_using_update_method
  ...
  u = Movie.find_by(title: "Wat?")
  u.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  d = Movie.find_by({ :title => "That One Where the Guy Kicks Another Guy Once"})
  d.destroy
end
